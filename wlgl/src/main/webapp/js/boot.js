...
var jqueryPATH = bootPATH.replace("/miniui/", "");

//debugger
mini_debugger = false; 
//miniui
document.write('<script src="' + jqueryPATH + '/common/js/jquery-1.9.1.min.js" type="text/javascript"></sc' + 'ript>');
...
document.write('<link href="' + bootPATH + '../system/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css" />');
